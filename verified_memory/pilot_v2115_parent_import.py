"""Outcome-blind, zero-provider authority and lineage import for V2.11.5.
...
The complete V2.11.2 authority source and the frozen V2.11.4 zero-call no-go
lineage are audited before any child authority is emitted.  V2.11.4 contributes
only its registered pre-dispatch denominator and cumulative ledger debit: it is
never treated as a reusable authority or scientific result.  No A-D or
cross-model artifact is returned, no provider module is imported, and no
provider client can be constructed here.
"""
...
from .pilot_contract import (
    PilotContract,
    _v2_11_5_expected_consumer_authority_normalization_amendment,
...
V2115_PARENT_IMPORT_SCHEMA_VERSION = "finevo-pilot-v2.11.5-parent-import-v1"
V2115_CALIBRATION_WRAPPER_SCHEMA_VERSION = (
    "finevo-pilot-v2.11.5-imported-calibration-wrapper-v1"
)
V2115_CAPABILITY_WRAPPER_SCHEMA_VERSION = (
    "finevo-pilot-v2.11.5-imported-capability-wrapper-v1"
)
V2115_PREFLIGHT_WRAPPER_SCHEMA_VERSION = (
    "finevo-pilot-v2.11.5-imported-preflight-authority-v1"
)
V2115_DEFAULT_RECEIPT_PATH = V2115_RAW_ROOT / "parent-import/parent_import_receipt.json"
...
V2115_SOURCE_MANIFEST_FILE_SHA256: str | None = (
    "fea5a276fb64fdd5bf0539014687ea39a891e9d305205b1d2046a2c15a892d16"
)
V2115_SOURCE_MANIFEST_CONTENT_SHA256: str | None = (
...
# Immutable V2.11.4 pre-dispatch zero-call no-go lineage.  Its V2.11.2-derived
# authority wrappers are not consumed here; the V2.11.2 source above is replayed
# directly.  These bindings preserve the registered denominator, the five
# completed operational cells, the 131 still-scheduled scientific cells, the
# absent dispatch-acceptance receipt, and cumulative budget/storage provenance.
V2114_CONTRACT_ID = "finevo-pilot-v2.11.4"
V2114_CONTRACT_PATH = PurePosixPath("experiments/pilot_v2_11_4.yaml")
V2114_CONTRACT_FILE_SHA256 = (
    "300abdbb0b2eb27fc1807a1a6af401ef9ad5b0ae9b43ecfceb98dee7fd30dd27"
)
V2114_CONTRACT_SHA256 = (
...
V2114_SCIENCE_TAG_OBJECT = "d774465ad006e9ae974f927ff7b4de94fd5f5147"
V2114_SCIENCE_COMMIT = "74f6c05dafc58fadf8d1b658ef3764d244676f76"
V2114_RAW_ROOT = PurePosixPath("experiment_results/pilot-v2.11.4/raw")
V2114_RAW_FILE_COUNT = 27
V2114_RAW_STORAGE_BYTES = 427_703
V2114_RAW_INVENTORY_SHA256 = (
    "b3e6228fc1873e64f792b4ab51af18104c38b402dbd13b2a7f14ef2ddcb0c89c"
)
V2114_RUN_LEDGER_FILE_SHA256 = (
    "49c06b1e23c72d280bcab6734fdb40040a2e65e31670970b3804ebcde34c7f13"
)
V2114_RUN_LEDGER_SHA256 = (
    "f0064120e279137fbd7dd5f5cec474aa384745b7c405d9371c90ac5c4f448656"
)
V2114_RUN_LEDGER_EVENT_COUNT = 7
V2114_RUN_LEDGER_EVENT_HEAD = (
    "6c5c297032aa5ea01b35556b34b55ec4f091a783fd0f90383304006794235861"
)
V2114_BUDGET_LEDGER_FILE_SHA256 = (
    "bdc771f1590fa1111978de7c12152d63b4524078324ceaa008dc717e7a7f2924"
)
V2114_BUDGET_LEDGER_SHA256 = (
    "d4ce8beebe1e462003039db2d39e6616c76cd33897c5b3e77e45989ced9d8789"
)
V2114_BUDGET_LEDGER_EVENT_COUNT = 12
V2114_BUDGET_LEDGER_EVENT_HEAD = (
    "737162cf298a9c5ec1d116c0238da531fd89ee9b91b231d9b135deb6bebb6fc6"
)
V2114_RELEASE_ATTESTATION_FILE_SHA256 = (
    "9737c690799394481d5c9e4632887d20e0364801d37e7287f9f3418ba0b5f3db"
)
V2114_RELEASE_ATTESTATION_SHA256 = (
    "50a371cbe79f47529e48b4dfd0e365762aa4b9c56ad2e593209c2942ea67b334"
)
V2114_LAUNCH_INPUT_FILE_SHA256 = (
    "59f4f3b8b0142e2753f701595e97266a21f7a72a9a108b14e1174b772b25d094"
)
V2114_LAUNCH_INPUT_SHA256 = (
    "cfc72441b959724e719622a9cbeaa871747635bf993aecdcafcaa7d2908ffedf"
)
V2114_PARENT_IMPORT_FILE_SHA256 = (
    "715bee790199b09f0a9e9d6da4a332e0b3b6e19e20dad4a24165171233505692"
)
V2114_PARENT_IMPORT_CONTENT_SHA256 = (
    "95ea29962a775a3017429476a3e65e1bd81c08b00f76699838589e55e8216e86"
)
V2114_POST_GATE_FILE_SHA256 = (
...
V2114_EXECUTION_LOCK_FILE_SHA256 = (
    "975aac602634d4b4296181e4de3ab0ef4620112d470609325a4867e160de0fbe"
)
V2114_ACCEPTANCE_RELATIVE_PATH = V2114_RAW_ROOT / "scientific_dispatch_acceptance.json"
V2114_ATTEMPT_COST_USD = 0.0
V2114_ATTEMPT_COMPLETIONS = 0
V2114_ATTEMPT_STORAGE_BYTES = 210_017
V2114_CUMULATIVE_COST_USD = 19.998220562500006
V2114_CUMULATIVE_COMPLETIONS = 1_004
V2114_CUMULATIVE_STORAGE_BYTES = 222_048_702
V2114_EXPECTED_STATUS_COUNTS = {"complete": 5, "scheduled": 131}
V2114_EXPECTED_STAGE_STATUS_COUNTS: Mapping[str, Mapping[str, int]] = {
    "parent-import": {"complete": 1},
    "capability-gate": {"complete": 2},
    "long-context-preflight": {"complete": 2},
    "experiment-c": {"scheduled": 25},
    "experiment-a": {"scheduled": 20},
...
V2114_INHERITED_V2113_DEBIT = ParentBudgetDebit(
    ...
    storage_bytes=221_838_685,
    record_sha256="3f75623b4eb5b6c3c1c2e2a7e97687c215da025cbea309f94e861abee47f90ca",
)
V2115_CUMULATIVE_DEBIT = ParentBudgetDebit(
    parent_contract_sha256=V2114_CONTRACT_SHA256,
    parent_run_ledger_sha256=V2114_RUN_LEDGER_SHA256,
    parent_budget_ledger_sha256=V2114_BUDGET_LEDGER_SHA256,
    stage_bucket="parent_v2114",
    cost_usd=V2114_CUMULATIVE_COST_USD,
    hosted_completions=V2114_CUMULATIVE_COMPLETIONS,
    storage_bytes=V2114_CUMULATIVE_STORAGE_BYTES,
    record_sha256="9595d037a21f429a59fd37febd4abd8283287e080ee9eb506ebf999e3d1e81a5",
)

V2115_ALLOWED_MODELS = ("gpt52_main", "gpt56_diagnostic")
...
_V2114_STAGE_RECEIPTS: Mapping[str, Mapping[str, Any]] = {
    "parent-import": {
        "file_sha256": "e70c685bcd8996582bfd5188475c83eb51be82f5560fc1fa6207ef115b28ab62",
        "content_sha256": "feb234442394a808909673318c45a59c95f26d9ae72006298f6aa99420659d10",
        "status": "complete",
        "go": True,
        "go_models": [],
    },
    "capability-gate": {
        "file_sha256": "46c5ba625f3095af81df3f64ff596cb50994524d9849e37463a91de86f7ddbdb",
        "content_sha256": "51f2f471b36d3edcc32ddb5b8c6cac1b1b3b142591a67cbf1e90ae0b1e2d68e4",
        "status": "complete",
        "go": True,
        "go_models": ["gpt52_main", "gpt56_diagnostic"],
    },
    "long-context-preflight": {
        "file_sha256": "0c512a912c0bc83cf524c145451582e2c30284a45c9eb1b0980a3f21957c1a5d",
        "content_sha256": "9f37e63ba866edf6124c21a2bf559e76753e78e0cf161e5d575f928b4e96789d",
        "status": "complete",
        "go": True,
        "go_models": ["gpt52_main", "gpt56_diagnostic"],
    },
...
V2115_PARSED_PARENT_SOURCE_ALLOWLIST = (
    ...
    "experiments/pilot_v2_11_4.yaml",
    "experiments/pilot_v2_11_4_source_manifest.json",
    "experiment_results/pilot-v2.11.4/raw/release_attestation.json",
    "experiment_results/pilot-v2.11.4/raw/scientific_launch_input.json",
    "experiment_results/pilot-v2.11.4/raw/run_ledger.json",
    "experiment_results/pilot-v2.11.4/raw/budget_ledger.json",
    "experiment_results/pilot-v2.11.4/raw/.real-stage-execution.lock",
    "experiment_results/pilot-v2.11.4/raw/parent-import/parent_import_receipt.json",
    "experiment_results/pilot-v2.11.4/raw/parent-import/stage_receipt.json",
    "experiment_results/pilot-v2.11.4/raw/capability-gate/stage_receipt.json",
    "experiment_results/pilot-v2.11.4/raw/long-context-preflight/stage_receipt.json",
    "experiment_results/pilot-v2.11.4/raw/long-context-preflight/post_gate_authority.json",
)
...
V2115_FORBIDDEN_IMPORT_PREFIXES = (
    ...
    "experiment_results/pilot-v2.11.4/raw/experiment-a/",
    "experiment_results/pilot-v2.11.4/raw/experiment-b/",
    "experiment_results/pilot-v2.11.4/raw/experiment-c/",
    "experiment_results/pilot-v2.11.4/raw/experiment-d/",
    "experiment_results/pilot-v2.11.4/raw/cross-model/",
)
...
class PilotV2115ParentImportError(RuntimeError):
    """Raised before any imported V2.11.5 authority can be consumed."""
...
def _json_copy(value: Any) -> Any:
    try:
        ...
        raise PilotV2115ParentImportError("value is not canonical JSON") from exc
...
def _strict_json(raw: bytes, *, name: str) -> dict[str, Any]:
    def pairs(rows: list[tuple[str, Any]]) -> dict[str, Any]:
        ...
        for key, value in rows:
            if key in result:
                raise PilotV2115ParentImportError(
    ...
    try:
        ...
        raise PilotV2115ParentImportError(f"{name} is not strict JSON") from exc
    if not isinstance(value, dict):
        raise PilotV2115ParentImportError(f"{name} must contain one object")
    return value
...
def _verify_seal(value: Mapping[str, Any], *, schema: str, name: str) -> str:
    ...
    if (
        ...
        raise PilotV2115ParentImportError(f"{name} seal drifted")
    return str(claimed)
...
def _strict_root(value: str | Path, *, name: str) -> Path:
    ...
    try:
        ...
        raise PilotV2115ParentImportError(f"{name} is unavailable") from exc
...
def _read_regular(root: Path, relative: PurePosixPath, *, name: str) -> bytes:
    ...
    for part in relative.parts[:-1]:
        ...
        try:
            ...
            raise PilotV2115ParentImportError(f"missing {name}: {relative}") from exc
        if stat.S_ISLNK(info.st_mode) or not stat.S_ISDIR(info.st_mode):
            raise PilotV2115ParentImportError(f"{name} path is not guarded")
    ...
    if stat.S_ISLNK(info.st_mode) or not stat.S_ISREG(info.st_mode):
        raise PilotV2115ParentImportError(f"{name} must be a regular file")
    ...
    try:
        ...
        raise PilotV2115ParentImportError(f"cannot read {name}") from exc
    if (
        ...
        raise PilotV2115ParentImportError(f"{name} changed during guarded read")
    return raw
...
def _read_parent_json(
    ...
    *,
    ...
    if relative.as_posix() not in V2115_PARSED_PARENT_SOURCE_ALLOWLIST:
        raise PilotV2115ParentImportError(
...
def _git(root: Path, *args: str) -> str:
    try:
        ...
        raise PilotV2115ParentImportError("git release verification failed") from exc
...
def _verify_event_ledger(
    ...
    *,
    ...
    if (
        ...
        raise PilotV2115ParentImportError(f"{name} identity drifted")
    previous = "0" * 64
    for index, event in enumerate(events):
        if not isinstance(event, Mapping):
            raise PilotV2115ParentImportError(f"{name} event is malformed")
        ...
        if (
            ...
            raise PilotV2115ParentImportError(f"{name} event chain drifted")
        previous = str(digest)
...
def _load_parent_contract(root: Path) -> tuple[PilotContract, dict[str, Any]]:
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 contract identity drifted")
    try:
        contract = load_pilot_contract(root.joinpath(*V2112_CONTRACT_PATH.parts))
    except Exception as exc:
        raise PilotV2115ParentImportError("V2.11.2 contract failed to load") from exc
    if contract.canonical_hash != V2112_CONTRACT_SHA256:
        raise PilotV2115ParentImportError("V2.11.2 parsed contract hash drifted")
...
def _verify_raw_inventory(root: Path) -> dict[str, Any]:
    ...
    if summary != expected:
        raise PilotV2115ParentImportError("V2.11.2 raw inventory drifted")
...
def _verify_attestation_and_launch(root: Path) -> dict[str, Any]:
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 attestation or launch input drifted")
    return {
...
def _verify_run_ledger(
    ...
    if _sha256(raw) != V2112_RUN_LEDGER_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.2 run ledger bytes drifted")
    ...
    if len(specs) != 136 or set(runs) != set(specs):
        raise PilotV2115ParentImportError("V2.11.2 ITT denominator drifted")
    ...
    for run_id, row in runs.items():
        if not isinstance(row, Mapping) or row.get("spec") != specs[run_id]:
            raise PilotV2115ParentImportError("V2.11.2 run/spec binding drifted")
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 terminal denominator drifted")
    return ledger, {
...
def _verify_budget_ledger(
    ...
    if _sha256(raw) != V2112_BUDGET_LEDGER_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.2 budget ledger bytes drifted")
    _verify_event_ledger(
        ledger,
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 attempt or cumulative debit drifted")
    return ledger, {
        **_binding(relative, raw, ledger),
        "internal_sha256": V2112_BUDGET_LEDGER_SHA256,
        "event_count": V2112_BUDGET_LEDGER_EVENT_COUNT,
...
def _verify_stage_receipts(root: Path) -> dict[str, Any]:
    ...
    for stage_id, expected in _STAGE_RECEIPTS.items():
        ...
        if (
            ...
            raise PilotV2115ParentImportError(f"V2.11.2 {stage_id} receipt drifted")
        result[stage_id] = _binding(relative, raw, receipt)
    return result


def _verify_v2114_git(root: Path) -> dict[str, str]:
    head = _git(root, "rev-parse", "--verify", "HEAD^{commit}")
    tag_object = _git(
        root, "rev-parse", "--verify", f"refs/tags/{V2114_SCIENCE_TAG}^{{tag}}"
    )
    tag_commit = _git(
        root, "rev-parse", "--verify", f"refs/tags/{V2114_SCIENCE_TAG}^{{commit}}"
    )
    tracked = _git(root, "status", "--porcelain=v1", "--untracked-files=no")
    if (
        head != V2114_SCIENCE_COMMIT
        or tag_commit != V2114_SCIENCE_COMMIT
        or tag_object != V2114_SCIENCE_TAG_OBJECT
        or tracked
    ):
        raise PilotV2115ParentImportError(
            "V2.11.4 annotated tag, commit, or tracked source drifted"
        )
    return {
        "science_tag": V2114_SCIENCE_TAG,
        "science_tag_object": tag_object,
        "resolved_git_commit": tag_commit,
    }


def _load_v2114_contract(root: Path) -> tuple[PilotContract, dict[str, Any]]:
    raw, value = _read_parent_json(
        root, V2114_CONTRACT_PATH, name="V2.11.4 contract"
    )
    if (
        _sha256(raw) != V2114_CONTRACT_FILE_SHA256
        or value.get("contract_id") != V2114_CONTRACT_ID
        or value.get("status") != "frozen"
        or value.get("implementation", {}).get("required_git_tag")
        != V2114_SCIENCE_TAG
        or value.get("integrity", {}).get("declared_sha256")
        != V2114_CONTRACT_SHA256
        or canonical_contract_sha256(value) != V2114_CONTRACT_SHA256
    ):
        raise PilotV2115ParentImportError("V2.11.4 contract identity drifted")
    try:
        contract = load_pilot_contract(root.joinpath(*V2114_CONTRACT_PATH.parts))
    except Exception as exc:
        raise PilotV2115ParentImportError("V2.11.4 contract failed to load") from exc
    if contract.canonical_hash != V2114_CONTRACT_SHA256:
        raise PilotV2115ParentImportError("V2.11.4 parsed contract hash drifted")
    return contract, _binding(V2114_CONTRACT_PATH, raw, value)


def _verify_v2114_raw_inventory(root: Path) -> dict[str, Any]:
    raw_root = root.joinpath(*V2114_RAW_ROOT.parts)
    try:
        rows, summary = _inventory(raw_root, declared_root=V2114_RAW_ROOT)
    except Exception as exc:
        raise PilotV2115ParentImportError(
            "V2.11.4 raw inventory verification failed"
        ) from exc
    expected = {
        "root": V2114_RAW_ROOT.as_posix(),
        "inventory_schema_version": "finevo-raw-tree-inventory-v1",
        "inventory_canonicalization": "json-sort-keys-compact-utf8-v1",
        "file_count": V2114_RAW_FILE_COUNT,
        "storage_bytes": V2114_RAW_STORAGE_BYTES,
        "inventory_sha256": V2114_RAW_INVENTORY_SHA256,
    }
    if summary != expected:
        raise PilotV2115ParentImportError("V2.11.4 raw inventory drifted")
    return {**expected, "rows": rows}


def _verify_v2114_attestation_and_launch(root: Path) -> dict[str, Any]:
    attestation_path = V2114_RAW_ROOT / "release_attestation.json"
    launch_path = V2114_RAW_ROOT / "scientific_launch_input.json"
    att_raw, att = _read_parent_json(
        root, attestation_path, name="V2.11.4 attestation"
    )
    launch_raw, launch = _read_parent_json(
        root, launch_path, name="V2.11.4 launch input"
    )
    local_tag = att.get("local_tag")
    if (
        _sha256(att_raw) != V2114_RELEASE_ATTESTATION_FILE_SHA256
        or att.get("schema_version") != "finevo-scientific-release-attestation-v2"
        or att.get("attestation_sha256") != V2114_RELEASE_ATTESTATION_SHA256
        or att.get("status") != "pass"
        or att.get("contract", {}).get("canonical_sha256")
        != V2114_CONTRACT_SHA256
        or att.get("head_commit") != V2114_SCIENCE_COMMIT
        or not isinstance(local_tag, Mapping)
        or local_tag.get("kind") != "annotated"
        or local_tag.get("name") != V2114_SCIENCE_TAG
        or local_tag.get("object_id") != V2114_SCIENCE_TAG_OBJECT
        or local_tag.get("peeled_commit") != V2114_SCIENCE_COMMIT
        or _sha256(launch_raw) != V2114_LAUNCH_INPUT_FILE_SHA256
        or launch.get("schema_version") != "finevo-scientific-launch-input-v1"
        or launch.get("launch_input_sha256") != V2114_LAUNCH_INPUT_SHA256
        or launch.get("contract_sha256") != V2114_CONTRACT_SHA256
    ):
        raise PilotV2115ParentImportError("V2.11.4 attestation or launch input drifted")
    return {
        "release_attestation": _binding(attestation_path, att_raw, att),
        "scientific_launch_input": _binding(launch_path, launch_raw, launch),
    }
...
def _verify_v2114_run_ledger(
    root: Path,
    contract: PilotContract,
) -> tuple[dict[str, Any], dict[str, Any]]:
    relative = V2114_RAW_ROOT / "run_ledger.json"
    raw, ledger = _read_parent_json(root, relative, name="V2.11.4 run ledger")
    if _sha256(raw) != V2114_RUN_LEDGER_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.4 run ledger bytes drifted")
    _verify_event_ledger(
        ledger,
        schema="finevo-pilot-run-ledger-v2",
        contract_sha256=V2114_CONTRACT_SHA256,
        internal_sha256=V2114_RUN_LEDGER_SHA256,
        event_count=V2114_RUN_LEDGER_EVENT_COUNT,
        event_head=V2114_RUN_LEDGER_EVENT_HEAD,
        run_count=136,
        name="V2.11.4 run ledger",
    )
    specs = {spec.run_id: spec.to_dict() for spec in contract.expand()}
    runs = ledger["runs"]
    if len(specs) != 136 or set(runs) != set(specs):
        raise PilotV2115ParentImportError("V2.11.4 ITT denominator drifted")
    by_stage: dict[str, Counter[str]] = defaultdict(Counter)
    totals: Counter[str] = Counter()
    for run_id, row in runs.items():
        if not isinstance(row, Mapping) or row.get("spec") != specs[run_id]:
            raise PilotV2115ParentImportError("V2.11.4 run/spec binding drifted")
        status = str(row.get("status"))
        stage_id = str(specs[run_id]["stage_id"])
        totals[status] += 1
        by_stage[stage_id][status] += 1
        if status == "complete":
            if stage_id not in {
                ...
                raise PilotV2115ParentImportError(
                    "V2.11.4 completed-cell boundary drifted"
                )
            continue
        if (
            status != "scheduled"
            ...
            or row.get("failure") is not None
            or row.get("terminal_at") is not None
        ):
            raise PilotV2115ParentImportError(
                "V2.11.4 pre-dispatch scheduled boundary drifted"
            )
    normalized_stages = {stage: dict(counts) for stage, counts in by_stage.items()}
    if (
        dict(totals) != V2114_EXPECTED_STATUS_COUNTS
        or normalized_stages
        != {
            stage: dict(counts)
            for stage, counts in V2114_EXPECTED_STAGE_STATUS_COUNTS.items()
        }
    ):
        raise PilotV2115ParentImportError("V2.11.4 terminal denominator drifted")
    return ledger, {
        **_binding(relative, raw, ledger),
        "internal_sha256": V2114_RUN_LEDGER_SHA256,
        "event_count": V2114_RUN_LEDGER_EVENT_COUNT,
        "event_head_sha256": V2114_RUN_LEDGER_EVENT_HEAD,
        "run_count": 136,
        "status_counts": dict(totals),
        "stage_status_counts": normalized_stages,
...
def _verify_v2114_budget_ledger(
    root: Path,
) -> tuple[dict[str, Any], dict[str, Any]]:
    relative = V2114_RAW_ROOT / "budget_ledger.json"
    raw, ledger = _read_parent_json(root, relative, name="V2.11.4 budget ledger")
    if _sha256(raw) != V2114_BUDGET_LEDGER_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.4 budget ledger bytes drifted")
    _verify_event_ledger(
        ledger,
        schema="finevo-pilot-budget-ledger-v2",
        contract_sha256=V2114_CONTRACT_SHA256,
        internal_sha256=V2114_BUDGET_LEDGER_SHA256,
        event_count=V2114_BUDGET_LEDGER_EVENT_COUNT,
        event_head=V2114_BUDGET_LEDGER_EVENT_HEAD,
        run_count=5,
        name="V2.11.4 budget ledger",
    )
    try:
        inherited = ParentBudgetDebit.from_dict(ledger["parent_debit"])
    except Exception as exc:
        raise PilotV2115ParentImportError(
            "V2.11.4 inherited budget debit is malformed"
        ) from exc
    rows = ledger["runs"]
    cost = math.fsum(float(row["actual"]["cost_usd"]) for row in rows.values())
    completions = sum(int(row["actual"]["completions"]) for row in rows.values())
    ...
    for row in rows.values():
        ...
        if (
            ...
            raise PilotV2115ParentImportError(
                "V2.11.4 budget ledger contains a current provider charge"
            )
    if (
        inherited != V2114_INHERITED_V2113_DEBIT
        or not math.isclose(cost, V2114_ATTEMPT_COST_USD, rel_tol=0, abs_tol=1e-12)
        or completions != V2114_ATTEMPT_COMPLETIONS
        or storage != V2114_ATTEMPT_STORAGE_BYTES
        or dict(statuses) != {"complete": 5}
        or not math.isclose(
            inherited.cost_usd + cost,
            V2114_CUMULATIVE_COST_USD,
            rel_tol=0,
            abs_tol=1e-12,
        )
        or inherited.hosted_completions + completions
        != V2114_CUMULATIVE_COMPLETIONS
        or inherited.storage_bytes + storage != V2114_CUMULATIVE_STORAGE_BYTES
    ):
        raise PilotV2115ParentImportError(
            "V2.11.4 attempt or cumulative debit drifted"
        )
    return ledger, {
        **_binding(relative, raw, ledger),
        "internal_sha256": V2114_BUDGET_LEDGER_SHA256,
        "event_count": V2114_BUDGET_LEDGER_EVENT_COUNT,
        "event_head_sha256": V2114_BUDGET_LEDGER_EVENT_HEAD,
        "run_count": 5,
        ...
        "cumulative_debit": V2115_CUMULATIVE_DEBIT.to_dict(),
    }


def _verify_v2114_stage_receipts(root: Path) -> dict[str, Any]:
    result: dict[str, Any] = {}
    for stage_id, expected in _V2114_STAGE_RECEIPTS.items():
        relative = V2114_RAW_ROOT / f"{stage_id}/stage_receipt.json"
        raw, receipt = _read_parent_json(
            root, relative, name=f"V2.11.4 {stage_id} receipt"
        )
        content = _verify_stage_receipt_seal(
            receipt,
            schema="finevo-pilot-stage-receipt-v2",
            name=f"V2.11.4 {stage_id} receipt",
        )
        if (
            _sha256(raw) != expected["file_sha256"]
            or content != expected["content_sha256"]
            or receipt.get("contract_id") != V2114_CONTRACT_ID
            or receipt.get("contract_sha256") != V2114_CONTRACT_SHA256
            or receipt.get("stage_id") != stage_id
            or receipt.get("status") != expected["status"]
            or receipt.get("status_counts")
            != dict(V2114_EXPECTED_STAGE_STATUS_COUNTS[stage_id])
            or receipt.get("terminal") is not True
            or receipt.get("denominator_terminal") is not True
            or receipt.get("go") is not expected["go"]
            or receipt.get("go_models") != expected["go_models"]
        ):
            raise PilotV2115ParentImportError(f"V2.11.4 {stage_id} receipt drifted")
        ...
        if (
            ...
            raise PilotV2115ParentImportError(
                f"V2.11.4 {stage_id} zero-provider boundary drifted"
            )
        if stage_id == "parent-import":
            zero_provider = (
                artifacts.get("provider_construction_during_import") is False
                and artifacts.get("provider_calls_during_import") == 0
                and artifacts.get("hosted_provider_calls_during_import") == 0
                and artifacts.get("hosted_cost_usd_during_import") == 0.0
            )
        else:
            zero_provider = (
                artifacts.get("provider_construction") is False
                and artifacts.get("provider_calls_current_attempt") == 0
            )
        if not zero_provider:
            raise PilotV2115ParentImportError(
                f"V2.11.4 {stage_id} zero-provider boundary drifted"
            )
        if stage_id == "long-context-preflight":
            gate = artifacts.get("post_gate_authority")
            if (
                not isinstance(gate, Mapping)
                or gate.get("file_sha256") != V2114_POST_GATE_FILE_SHA256
                or gate.get("receipt_sha256") != V2114_POST_GATE_CONTENT_SHA256
                or gate.get("go") is not True
                or gate.get("provider_calls_during_authority") != 0
                or gate.get("eligible_model_ids")
                != ["gpt52_main", "gpt56_diagnostic"]
            ):
                raise PilotV2115ParentImportError(
                    "V2.11.4 global post-gate binding drifted"
                )
        result[stage_id] = _binding(relative, raw, receipt)
    return result


def _verify_v2114_parent_import_lineage(root: Path) -> dict[str, Any]:
    relative = V2114_RAW_ROOT / "parent-import/parent_import_receipt.json"
    raw, receipt = _read_parent_json(
        root, relative, name="V2.11.4 parent import receipt"
    )
    content = _verify_seal(
        receipt,
        schema="finevo-pilot-v2.11.4-parent-import-v1",
        name="V2.11.4 parent import receipt",
    )
    policy = receipt.get("import_policy")
    if (
        _sha256(raw) != V2114_PARENT_IMPORT_FILE_SHA256
        or content != V2114_PARENT_IMPORT_CONTENT_SHA256
        or receipt.get("child_release", {}).get("contract_sha256")
        != V2114_CONTRACT_SHA256
        or receipt.get("child_release", {}).get("resolved_git_commit")
        != V2114_SCIENCE_COMMIT
        or receipt.get("child_release", {}).get("git_tag") != V2114_SCIENCE_TAG
        ...
        raise PilotV2115ParentImportError(
            "V2.11.4 parent import lineage drifted"
        )
    return _binding(relative, raw, receipt)


def _verify_v2114_source_manifest_lineage(root: Path) -> dict[str, Any]:
    relative = PurePosixPath("experiments/pilot_v2_11_4_source_manifest.json")
    raw, manifest = _read_parent_json(
        root, relative, name="V2.11.4 source manifest"
    )
    content = _verify_seal(
        manifest,
        schema="finevo-pilot-v2.11.4-source-manifest-v1",
        name="V2.11.4 source manifest",
    )
    gate = manifest.get("source_gate_binding")
    if (
        _sha256(raw) != V2114_SOURCE_MANIFEST_FILE_SHA256
        or content != V2114_SOURCE_MANIFEST_CONTENT_SHA256
        or not isinstance(gate, Mapping)
        or gate.get("receipt_file_sha256") != V2112_POST_GATE_FILE_SHA256
        or gate.get("receipt_content_sha256") != V2112_POST_GATE_CONTENT_SHA256
        or gate.get("git_commit") != V2112_SCIENCE_COMMIT
        or manifest.get("cumulative_budget_debit", {}).get("record_sha256")
        != "3f75623b4eb5b6c3c1c2e2a7e97687c215da025cbea309f94e861abee47f90ca"
    ):
        raise PilotV2115ParentImportError("V2.11.4 source manifest lineage drifted")
    return _binding(relative, raw, manifest)


def _verify_v2114_post_gate_lineage(
    root: Path,
    contract: PilotContract,
) -> dict[str, Any]:
    relative = V2114_RAW_ROOT / "long-context-preflight/post_gate_authority.json"
    raw = _read_regular(root, relative, name="V2.11.4 global post gate")
    if _sha256(raw) != V2114_POST_GATE_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.4 global post-gate bytes drifted")
    try:
        binding = verified_v2114_gate_authority_binding(
            root.joinpath(*relative.parts),
            repo_root=root,
            expected_git_commit=V2114_SCIENCE_COMMIT,
            expected_contract_sha256=V2114_CONTRACT_SHA256,
            contract=contract,
        )
    except PilotV2114GateError as exc:
        raise PilotV2115ParentImportError(
            f"V2.11.4 global post-gate replay failed: {exc}"
        ) from exc
    if (
        binding.get("receipt_path") != relative.as_posix()
        or binding.get("receipt_file_sha256") != V2114_POST_GATE_FILE_SHA256
        or binding.get("receipt_content_sha256") != V2114_POST_GATE_CONTENT_SHA256
        or binding.get("git_commit") != V2114_SCIENCE_COMMIT
        or set(binding.get("reservations", {}))
        != {"openai/gpt-5.2-2025-12-11", "openai/gpt-5.6-sol"}
    ):
        raise PilotV2115ParentImportError("V2.11.4 global post-gate binding drifted")
    return _json_copy(binding)


def _verify_v2114_acceptance_absence(root: Path) -> dict[str, Any]:
    acceptance = root.joinpath(*V2114_ACCEPTANCE_RELATIVE_PATH.parts)
    try:
        acceptance.lstat()
        ...
        raise PilotV2115ParentImportError(
            "V2.11.4 scientific dispatch acceptance unexpectedly exists"
        )
    lock_relative = V2114_RAW_ROOT / ".real-stage-execution.lock"
    raw, lock = _read_parent_json(
        root, lock_relative, name="V2.11.4 scientific-dispatch lock"
    )
    if (
        _sha256(raw) != V2114_EXECUTION_LOCK_FILE_SHA256
        or set(lock) != {"acquired_at", "pid", "schema_version", "stage_id"}
        or lock.get("schema_version") != "finevo-pilot-execution-lock-v1"
        or lock.get("stage_id") != "scientific-dispatch-acceptance"
        or not isinstance(lock.get("pid"), int)
        or not isinstance(lock.get("acquired_at"), str)
    ):
        raise PilotV2115ParentImportError(
            "V2.11.4 scientific-dispatch no-go marker drifted"
        )
    return {
        "acceptance_receipt": {
            "path": V2114_ACCEPTANCE_RELATIVE_PATH.as_posix(),
            "present": False,
            "status": "absent-pre-dispatch-no-go",
        },
        "execution_lock": _binding(lock_relative, raw, lock),
    }


def _audit_v2114_terminal_lineage(
    *,
    lineage_repo_root: str | Path,
) -> dict[str, Any]:
    """Audit the frozen V2.11.4 pre-dispatch no-go without consuming authority."""

    root = _strict_root(
        lineage_repo_root, name="V2.11.4 pre-dispatch no-go lineage source"
    )
    git = _verify_v2114_git(root)
    contract, contract_binding = _load_v2114_contract(root)
    inventory = _verify_v2114_raw_inventory(root)
    launch = _verify_v2114_attestation_and_launch(root)
    _, run_binding = _verify_v2114_run_ledger(root, contract)
    _, budget_binding = _verify_v2114_budget_ledger(root)
    stage_receipts = _verify_v2114_stage_receipts(root)
    parent_import = _verify_v2114_parent_import_lineage(root)
    source_manifest = _verify_v2114_source_manifest_lineage(root)
    post_gate = _verify_v2114_post_gate_lineage(root, contract)
    no_go = _verify_v2114_acceptance_absence(root)
    return {
        "lineage_root": root,
        "contract": contract,
        "release": git,
        ...
        **launch,
        ...
        "post_gate_authority": post_gate,
        **no_go,
        "parent_attempt_denominator": {
            "registered_cells": 136,
            "terminal_cells": 5,
            "scheduled_cells": 131,
            "completed_operational_cells": 5,
            "scheduled_scientific_cells": 131,
            "status_counts": dict(V2114_EXPECTED_STATUS_COUNTS),
            "stage_status_counts": {
                stage: dict(counts)
                for stage, counts in V2114_EXPECTED_STAGE_STATUS_COUNTS.items()
            },
            ...
            "implementation_root_cause": (
                "global-vs-per-model-authority-provenance-comparison-gap"
            ),
            "post_gate_go": True,
            "scientific_dispatch_acceptance_present": False,
...
def _deep_verify_post_gate(
    ...
    *,
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 post-gate bytes drifted")
    try:
    ...
    for model_id in V2115_ALLOWED_MODELS:
        ...
        if not checkpoint_raw or not exactness_raw or not journal_raw:
            raise PilotV2115ParentImportError("empty V2.11.2 preflight source")

    science_ids: dict[str, list[str]] = {
        model_id: [] for model_id in V2115_ALLOWED_MODELS
    }
    for stage_id in (
        "experiment-c",
        "experiment-a",
    ...
    if (
        ...
        raise PilotV2115ParentImportError("V2.11.2 post-gate ledger prefix is absent")
    pre_science_ids = {
        spec.run_id
    ...
    if not isinstance(budget_rows, Mapping):
        raise PilotV2115ParentImportError("V2.11.2 budget rows are malformed")
...
def _audit_parent_release(
    *,
    ...
    if _sha256(parent_raw) != V2112_PARENT_IMPORT_FILE_SHA256:
        raise PilotV2115ParentImportError("V2.11.2 parent import bytes drifted")
    try:
    ...
    if parent_receipt.get("integrity", {}).get(
        ...
        raise PilotV2115ParentImportError("V2.11.2 reusable wrappers drifted")
...
def build_v2115_source_manifest(
    *,
    source_repo_root: str | Path,
    lineage_repo_root: str | Path,
    evidence_repo_root: str | Path,
) -> dict[str, Any]:
    """Build the tracked manifest from V2.11.2 authority and V2.11.4 lineage."""
    ...
    return _seal(
        {
            "schema_version": V2115_SOURCE_MANIFEST_SCHEMA_VERSION,
            ...
            "terminal_lineage_release": {
                ...
                **lineage["release"],
                ...
                "post_gate_authority": lineage["post_gate_authority"],
                "scientific_dispatch_acceptance": lineage["acceptance_receipt"],
                "scientific_dispatch_execution_lock": lineage["execution_lock"],
            },
            ...
            "parent_attempt_denominator": lineage["parent_attempt_denominator"],
            "parsed_source_allowlist": list(V2115_PARSED_PARENT_SOURCE_ALLOWLIST),
            "reusable_authority_allowlist": list(V2115_REUSABLE_AUTHORITY_KINDS),
            "forbidden_import_prefixes": list(V2115_FORBIDDEN_IMPORT_PREFIXES),
            "calibration_source": {
            ...
            "consumer_authority_normalization": _json_copy(
                _v2_11_5_expected_consumer_authority_normalization_amendment()[
                    "consumer_authority_normalization_repair"
                ]
            ),
            "cumulative_budget_debit": V2115_CUMULATIVE_DEBIT.to_dict(),
            "import_policy": {
                **_ZERO_PROVIDER_POLICY,
                ...
                "v2114_registered_lineage_cells_audited": 136,
                "v2114_completed_operational_cells_audited": 5,
                "v2114_scheduled_scientific_cells_audited": 131,
                "v2114_scientific_cells_imported": 0,
                "v2114_provider_calls_current_attempt": 0,
                "v2114_hosted_cost_usd_current_attempt": 0.0,
            ...
            "observation_boundary": {
                ...
                "v2_11_4_scientific_cell_reuse": "forbidden",
                "v2_11_4_pre_dispatch_no_go_is_lineage_only": True,
                "v2_11_4_scientific_dispatch_acceptance_present": False,
                "v2_11_4_actor_performance_outcomes_generated": False,
                "failed_seed_replacement": "forbidden",
                "matrix_shrink": "forbidden",
                "fresh_v2_11_5_scientific_cells": 131,
...
def _load_tracked_manifest(repo_root: Path) -> dict[str, Any]:
    if (
        V2115_SOURCE_MANIFEST_FILE_SHA256 is None
        or V2115_SOURCE_MANIFEST_CONTENT_SHA256 is None
    ):
        raise PilotV2115ParentImportError(
            "V2.11.5 source manifest hashes are not sealed"
        )
    raw, value = _read_json(
        repo_root,
        V2115_SOURCE_MANIFEST_PATH,
        name="tracked V2.11.5 source manifest",
    )
    content = _verify_seal(
        value,
        schema=V2115_SOURCE_MANIFEST_SCHEMA_VERSION,
        name="tracked V2.11.5 source manifest",
    )
    canonical = (
    ...
    if (
        raw != canonical
        or _sha256(raw) != V2115_SOURCE_MANIFEST_FILE_SHA256
        or content != V2115_SOURCE_MANIFEST_CONTENT_SHA256
    ):
        raise PilotV2115ParentImportError(
            "tracked V2.11.5 source manifest hash/canonicalization drifted"
        )
    return value


def write_v2115_source_manifest_draft(
    path: str | Path,
    ...
    _verify_seal(
        manifest,
        schema=V2115_SOURCE_MANIFEST_SCHEMA_VERSION,
        name="V2.11.5 source manifest draft",
    )
    target = Path(path)
    if target.exists() or target.is_symlink():
        raise PilotV2115ParentImportError(
            f"refusing to overwrite V2.11.5 source manifest: {target}"
        )
...
def load_v2115_source_manifest(*, repo_root: str | Path) -> dict[str, Any]:
    return _load_tracked_manifest(_strict_root(repo_root, name="V2.11.5 repository"))


def validate_v2115_source_manifest(
    value: Mapping[str, Any],
    *,
    source_repo_root: str | Path,
    lineage_repo_root: str | Path,
    ...
    _verify_seal(
        selected,
        schema=V2115_SOURCE_MANIFEST_SCHEMA_VERSION,
        name="V2.11.5 source manifest",
    )
    expected = build_v2115_source_manifest(
    ...
    if selected != expected:
        raise PilotV2115ParentImportError(
            "V2.11.5 source manifest differs from immutable authority/lineage replay"
        )
    return selected
...
def _validate_child(
    *,
    ...
    if (
        getattr(contract, "contract_id", None) != V2115_CONTRACT_ID
        ...
        raise PilotV2115ParentImportError(
            "V2.11.5 import requires its exact release-bound contract"
        )
    return {
...
def _source_manifest_binding() -> dict[str, str]:
    ...
    return {
        "path": V2115_SOURCE_MANIFEST_PATH.as_posix(),
...
def _terminal_lineage_binding() -> dict[str, str]:
    return {
        ...
        "git_tag_object": V2114_SCIENCE_TAG_OBJECT,
        "resolved_git_commit": V2114_SCIENCE_COMMIT,
    }
        ...
        preflights[model_id] = _seal(
            {
                ...
                "scientific_evidence": False,
                "evidence_use": (
                    "Prospective V2.11.5 dispatch-budget authority only; no "
...
def build_v2115_parent_import(
    *,
    ...
    child_root = _strict_root(repo_root, name="V2.11.5 repository")
    ...
    _audit_v2114_terminal_lineage(lineage_repo_root=lineage_repo_root)
    rebuilt_manifest = build_v2115_source_manifest(
        source_repo_root=source_repo_root,
        lineage_repo_root=lineage_repo_root,
        evidence_repo_root=evidence_root,
    )
    if tracked != rebuilt_manifest:
        raise PilotV2115ParentImportError(
            "tracked V2.11.5 source manifest differs from immutable replay"
        )
    ...
    return _seal(
        {
            "schema_version": V2115_PARENT_IMPORT_SCHEMA_VERSION,
            "child_release": child,
            "source_manifest": _source_manifest_binding(),
            "authority_parent_release": {
            ...
            "terminal_lineage_release": {
                **_terminal_lineage_binding(),
                "release_attestation_sha256": V2114_RELEASE_ATTESTATION_SHA256,
                "run_ledger_sha256": V2114_RUN_LEDGER_SHA256,
                "budget_ledger_sha256": V2114_BUDGET_LEDGER_SHA256,
                "source_manifest_content_sha256": (
                    V2114_SOURCE_MANIFEST_CONTENT_SHA256
                ),
                "post_gate_receipt_file_sha256": V2114_POST_GATE_FILE_SHA256,
                "post_gate_receipt_content_sha256": V2114_POST_GATE_CONTENT_SHA256,
                "scientific_dispatch_acceptance_present": False,
                "publication_status": "immutable-pre-dispatch-acceptance-no-go",
            },
            "parent_attempt_denominator": _json_copy(
                tracked["parent_attempt_denominator"]
            ),
            ...
            "cumulative_parent_budget_debit": V2115_CUMULATIVE_DEBIT.to_dict(),
            "import_policy": _json_copy(tracked["import_policy"]),
            "scientific_evidence": False,
            "claim_boundary": (
                "V2.11.5 reuses only calibration, capability/interface, and "
                "fresh-preflight observed-p95 budget authority directly from "
                "V2.11.2. V2.11.4 contributes only its pre-dispatch acceptance "
                "no-go, five completed operational cells, 131 scheduled cells, "
                "and cumulative budget lineage. All 131 A-D/cross-model cells "
                "are fresh V2.11.5 cells; all earlier scientific outcomes and "
                "decoded completions are excluded."
            ),
        }
    )


def validate_v2115_parent_import_receipt(
    ...
    *,
    ...
    root = _strict_root(repo_root, name="V2.11.5 repository")
    value = _json_copy(dict(receipt))
    _verify_seal(
        value,
        schema=V2115_PARENT_IMPORT_SCHEMA_VERSION,
    ...
    if (
        ...
        != {
            **_terminal_lineage_binding(),
            ...
            "run_ledger_sha256": V2114_RUN_LEDGER_SHA256,
            "budget_ledger_sha256": V2114_BUDGET_LEDGER_SHA256,
            "source_manifest_content_sha256": V2114_SOURCE_MANIFEST_CONTENT_SHA256,
            "post_gate_receipt_file_sha256": V2114_POST_GATE_FILE_SHA256,
            "post_gate_receipt_content_sha256": V2114_POST_GATE_CONTENT_SHA256,
            "scientific_dispatch_acceptance_present": False,
            "publication_status": "immutable-pre-dispatch-acceptance-no-go",
        }
        or value.get("parent_attempt_denominator")
        != manifest["parent_attempt_denominator"]
    ...
    if (
        ...
        or set(capabilities) != set(V2115_ALLOWED_MODELS)
        or not isinstance(preflights, Mapping)
        or set(preflights) != set(V2115_ALLOWED_MODELS)
    ):
        raise PilotV2115ParentImportError("V2.11.5 wrapper denominator drifted")
    _verify_seal(
        calibration,
        schema=V2115_CALIBRATION_WRAPPER_SCHEMA_VERSION,
        name="V2.11.5 calibration wrapper",
    )
    if (
        ...
        raise PilotV2115ParentImportError(
            "V2.11.5 calibration wrapper source boundary drifted"
        )
    for model_id in V2115_ALLOWED_MODELS:
        _verify_seal(
            capabilities[model_id],
            schema=V2115_CAPABILITY_WRAPPER_SCHEMA_VERSION,
            name=f"V2.11.5 {model_id} capability wrapper",
        )
        _verify_seal(
            preflights[model_id],
            schema=V2115_PREFLIGHT_WRAPPER_SCHEMA_VERSION,
            name=f"V2.11.5 {model_id} preflight wrapper",
        )
        ...
        if (
            ...
            raise PilotV2115ParentImportError(
                f"V2.11.5 {model_id} preflight wrapper scope drifted"
            )
    return value


def verify_v2115_parent_import_receipt(
    ...
    *,
    ...
    if commit is None or (
        ...
        raise PilotV2115ParentImportError(
            "V2.11.5 parent receipt requires one exact child commit"
        )
    if raw_root is not None:
        raw = Path(raw_root)
        if not raw.is_absolute():
            raw = root.joinpath(*PurePosixPath(str(raw_root)).parts)
        if raw.absolute() != root.joinpath(*V2115_RAW_ROOT.parts):
            raise PilotV2115ParentImportError(
                "V2.11.5 parent receipt raw namespace drifted"
            )
    if isinstance(receipt, Mapping):
        observed = _json_copy(dict(receipt))
    else:
        path = Path(receipt).absolute()
        expected = root.joinpath(*V2115_DEFAULT_RECEIPT_PATH.parts)
        if path != expected:
            raise PilotV2115ParentImportError(
                "V2.11.5 parent receipt path differs from raw namespace"
            )
        raw = _read_regular(
            root,
        ...
        observed = _strict_json(raw, name="V2.11.5 parent import receipt")
    ...
    if source_repo_root is None or lineage_repo_root is None:
        raise PilotV2115ParentImportError(
            "V2.11.5 exact replay requires both authority and lineage checkouts"
        )
    expected = build_v2115_parent_import(
        repo_root=root,
        contract=contract,
        child_git_commit=commit,
        source_repo_root=source_repo_root,
    ...
    if observed != expected:
        raise PilotV2115ParentImportError(
            "V2.11.5 parent import receipt differs from exact source replay"
        )
    return observed
...
def _atomic_json(
    ...
    *,
    ...
    try:
        ...
        raise PilotV2115ParentImportError(
            f"immutable V2.11.5 write failed: {exc}"
        ) from exc


def persist_v2115_parent_import(
    *,
    repo_root: str | Path,
    contract: PilotContract,
    child_git_commit: str | None = None,
    ...
    if (
        ...
        raise PilotV2115ParentImportError(
            "V2.11.5 parent import requires one exact commit plus authority and lineage checkouts"
        )
    if raw_root is not None:
        raw = Path(raw_root)
        if not raw.is_absolute():
        ...
        if raw.absolute() != root.joinpath(*V2115_RAW_ROOT.parts):
            raise PilotV2115ParentImportError(
                "V2.11.5 parent import raw namespace drifted"
            )
    ...
    path = (
        root.joinpath(*V2115_DEFAULT_RECEIPT_PATH.parts)
        if destination is None
        else Path(destination).absolute()
    )
    if path != root.joinpath(*V2115_DEFAULT_RECEIPT_PATH.parts):
        raise PilotV2115ParentImportError(
            "V2.11.5 receipt destination differs from raw namespace"
        )
...
def parent_budget_debit_for_v2115(contract: Any = None) -> ParentBudgetDebit | None:
    if getattr(contract, "contract_id", None) != V2115_CONTRACT_ID:
        return None
    return V2115_CUMULATIVE_DEBIT


def calibration_wrapper_from_v2115_receipt(
    receipt: Mapping[str, Any],
    *,
    ...
    if contract is not None or expected_git_commit is not None or repo_root is not None:
        if contract is None or expected_git_commit is None or repo_root is None:
            raise PilotV2115ParentImportError(
                "V2.11.5 wrapper validation requires root, contract, and commit"
            )
        validate_v2115_parent_import_receipt(
            receipt,
            contract=contract,
    ...
    if not isinstance(wrapper, Mapping):
        raise PilotV2115ParentImportError("V2.11.5 calibration wrapper is absent")
    _verify_seal(
        wrapper,
        schema=V2115_CALIBRATION_WRAPPER_SCHEMA_VERSION,
        name="V2.11.5 calibration wrapper",
...
def capability_wrappers_from_v2115_receipt(
    receipt: Mapping[str, Any],
    *,
    contract: PilotContract | None = None,
    expected_git_commit: str | None = None,
    ...
    if not isinstance(wrappers, Mapping) or set(wrappers) != set(V2115_ALLOWED_MODELS):
        raise PilotV2115ParentImportError("V2.11.5 capability wrappers drifted")
    result: dict[str, dict[str, Any]] = {}
    for model_id in V2115_ALLOWED_MODELS:
        wrapper = wrappers[model_id]
        if not isinstance(wrapper, Mapping):
            raise PilotV2115ParentImportError("capability wrapper is malformed")
        _verify_seal(
            wrapper,
            schema=V2115_CAPABILITY_WRAPPER_SCHEMA_VERSION,
            name=f"V2.11.5 {model_id} capability wrapper",
...
def preflight_wrappers_from_v2115_receipt(
    receipt: Mapping[str, Any],
    *,
    contract: PilotContract | None = None,
    expected_git_commit: str | None = None,
    ...
    if not isinstance(wrappers, Mapping) or set(wrappers) != set(V2115_ALLOWED_MODELS):
        raise PilotV2115ParentImportError("V2.11.5 preflight wrappers drifted")
    result: dict[str, dict[str, Any]] = {}
    for model_id in V2115_ALLOWED_MODELS:
        wrapper = wrappers[model_id]
        if not isinstance(wrapper, Mapping):
            raise PilotV2115ParentImportError("preflight wrapper is malformed")
        _verify_seal(
            wrapper,
            schema=V2115_PREFLIGHT_WRAPPER_SCHEMA_VERSION,
            name=f"V2.11.5 {model_id} preflight wrapper",
        ...
        if canonical_sha256(wrapper.get("reservations")) != wrapper.get(
            ...
            raise PilotV2115ParentImportError(
                f"V2.11.5 {model_id} preflight reservation hash drifted"
            )
        result[model_id] = _json_copy(wrapper)
    return result
...
__all__ = [
    ...
    "V2115_PARENT_IMPORT_SCHEMA_VERSION",
    "V2115_PREFLIGHT_WRAPPER_SCHEMA_VERSION",
    "V2115_RAW_ROOT",
    "V2115_SCIENCE_TAG",
    ...
    "V2115_SOURCE_MANIFEST_PATH",
    "V2115_SOURCE_MANIFEST_SCHEMA_VERSION",
