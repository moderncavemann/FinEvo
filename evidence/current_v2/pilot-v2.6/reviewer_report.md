# FinEvo V2.6 local-first mechanism pilot evidence report

- Contract: `finevo-pilot-v2.6` / `bb6b12d71227c423e5a67452dc496f26843dec74e359b9b04bf096dc17d0c509`
...
| not-applicable | Narrative channel shows controlled semantic response | not registered in the V2.6 core matrix | aggregate.json#/narrative | deferred-unregistered | make no V2.6 narrative or real-news-understanding claim |
...
| all | Complete V2.6 preregistered ITT denominator | one terminal ledger row for every expanded contract cell | failure_ledger.json | supported | retain every failed, stopped, nonterminal, and missing cell |
...
- Status counts: `{"complete": 16, "integrity-stopped": 195}`
- Budget control: `true`
