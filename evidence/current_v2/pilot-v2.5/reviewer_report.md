# FinEvo V2.5 local-first mechanism pilot evidence report

- Contract: `finevo-pilot-v2.5` / `1f9809062684a1a2afb96b7342b88a06810e0e87ac883aa63a858a65a81d188d`
...
| not-applicable | Narrative channel shows controlled semantic response | not registered in the V2.5 core matrix | aggregate.json#/narrative | deferred-unregistered | make no V2.5 narrative or real-news-understanding claim |
...
| all | Complete V2.5 preregistered ITT denominator | one terminal ledger row for every expanded contract cell | failure_ledger.json | supported | retain every failed, stopped, nonterminal, and missing cell |
...
- Status counts: `{"complete": 2, "failed": 14, "integrity-stopped": 195}`
- Budget control: `true`
