...
- Contract: `finevo-pilot-v2.4` / `12d27b165a36fd0645ddedbf06e8d10a1f178b895272da6f4ea929b73d8506c3`
...
| not-applicable | Narrative channel shows controlled semantic response | not registered in the V2.4 core matrix | aggregate.json#/narrative | deferred-unregistered | make no V2.4 narrative or real-news-understanding claim |
...
| all | Complete V2.4 preregistered ITT denominator | one terminal ledger row for every expanded contract cell | failure_ledger.json | supported | retain every failed, stopped, nonterminal, and missing cell |
...
- Status counts: `{"integrity-stopped": 211}`
- Budget control: `false`
