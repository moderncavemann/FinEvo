#!/usr/bin/env python3
"""Render the compact and expanded V2.9 pilot contracts deterministically."""
...
def main() -> int:
    ...
    overlay = {
        "schema_version": PILOT_CONTRACT_OVERLAY_SCHEMA_VERSION_V2_9,
    ...
    (EXPERIMENTS / "pilot_v2_9.yaml").write_text(
