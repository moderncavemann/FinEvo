...
% ============================================================================
\def\FinEvoAllowHistoricalPrePZeroEvidence{}
...
\begin{center}
\fbox{\parbox{0.94\textwidth}{\centering\textbf{HISTORICAL PRE-P0 V1 MANUSCRIPT.}
This document and its numerical claims predate the current Evidence-Grounded
Rule Memory method and must not be cited as evidence for that method.}}
\end{center}
